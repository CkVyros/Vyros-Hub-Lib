...
if not Success then
	warn("\nVyros Hub |  Key System - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if VyrosLib.Flags[a] then
			...
			warn("Vyros Hub |  Key System Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function VyrosLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Vyros Hub |  Key System"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Vyros Hub |  Key System"
